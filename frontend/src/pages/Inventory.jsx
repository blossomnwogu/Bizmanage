...
function Inventory() {
  ...
  // MongoDB is the source of truth for inventory.
  useEffect(() => {
    let active = true;
    ...
    <div>
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
          <p className="text-sm text-[var(--muted-text)]">Total Products</p>
          <h2 className="mt-3 text-3xl font-bold">{products.length}</h2>
        </div>

        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
          <p className="text-sm text-[var(--muted-text)]">Total Stock</p>
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
          <p className="text-sm text-[var(--muted-text)]">Low Stock Items</p>
      ...
      <section className="mt-10 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
        ...
        <form onSubmit={handleSubmit} className="mt-6 grid gap-5 md:grid-cols-3">
          ...
          <button
            type="submit"
            disabled={saving}
            className="md:col-span-3 rounded-lg bg-[var(--primary)] px-6 py-3 font-semibold text-[#2E2528] transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
          >
